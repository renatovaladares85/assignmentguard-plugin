...
final class ActorInputParser
{
    public function parse($ticket, array $input): array
    {
        ...
        if (array_key_exists('_actors', $input)) {
            return $this->parseActors($input, $existing);
        }
    ...
    private function parseActors(array $input, array $existing): array
    {
        ...
        return $this->makeDelta('actors', $existing, array_keys($inputGroups), $input);
    }
